...
import './DontFollow.css';
import CoverPic2 from '../CoverPic2/CoverPic2'

class DontFollow extends Component {
  
  render() {
    var Card;
    var notFollowArray = this.props.pending_followers_array
    if(notFollowArray.length > 0){
      Card = notFollowArray.map(user =>(
    ...
    return (
      ...
      <center>Here is a list of people who follow you but you do not follow<br/>
        We suggest you follow them back
      </center>
           {Card}
      </div></div>
    )
