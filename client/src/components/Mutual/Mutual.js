...
class Mutual extends Component {
  ...
  render() {
    var Card;
    var usersArray = this.props.mutual_array;
    ...
    return (
      ...
      <center>Here is a list of people who you follow and are following you also<br/>
        These are your <b className="hiTitle">Real Padi's</b>
      </center>
           {Card}
 </div>
      </div>
